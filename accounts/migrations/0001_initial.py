    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Patient'), ('paramedic', 'Paramedic'), ('admin', 'Admin')], default='patient', max_length=20)),
                ...
                ('license_number', models.CharField(blank=True, help_text='For paramedics only', max_length=50, null=True)),
